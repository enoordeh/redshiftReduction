...
; Filter out zero padding from test dataset
spec = spec[WHERE(spec GT -100, /NULL)]
; print, "objflux: ", spec
ivar = ivar[WHERE(ivar GT -100, /NULL)]
; print, "ivar: ", ivar
wav = wav[WHERE(wav GT -100, /NULL)]
...
WRITE_CSV, out_db2, gal_struct.rchi2_1, gal_struct.rchi2_2, star_struct.rchi2_1, star_struct.rchi2_2, qso_struct.rchi2_1, qso_struct.rchi2_2
